...
class JDPluginConfig():
	...
	def _loadConfig(self):
		return
		self.yaml_str = readYAML(self.path)
		JD_EntLibrary.regex_filter = re.compile('*')
		print(f'{DEBUG_PREFIX} config yaml_str: {self.yaml_str}')
		# ...set class properties...
		pass

	def saveConfig(self, config_file_path):
		writeYAML(self.path, self.yaml_str)
		pass
